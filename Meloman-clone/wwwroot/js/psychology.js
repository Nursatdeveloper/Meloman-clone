$(document).ready(function () {
    ...
    $.ajax({
        ...
        type: "POST",
        data: { 'category': 'Психологическая литература' },
        cache: false,
...
function sortByPrice(fromPrice, toPrice) {
    if (toPrice == '') {
        ...
        $.ajax({
            url: "/Books/GetBooksSortedByPrice",
            type: "POST",
            data: { 'fromPrice': fromPrice, 'toPrice': toPrice, 'category': 'Психологическая литература' },
            cache: false,
            success: function (data) {
                $(".book-list-container").empty();
...
function getSortedBooks(urlPath) {
    $.ajax({
        ...
        type: "POST",
        data: {
            'category': 'Психологическая литература',
            'authors': authors,
